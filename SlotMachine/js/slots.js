...
function buildReels(Reel1, Reel2, Reel3) {
...
function buildSlotMachine() {
    ...
    ResetButton.addEventListener("mouseout", function (event) {
    ...
    PowerButton.addEventListener("mouseover", function (event) {
        PowerButton.alpha = 0.5;
    });
    PowerButton.addEventListener("mouseout", function (event) {
    ...
    SpinButton.addEventListener("mouseout", function (event) {
        SpinButton.alpha = 1;
    });
    ...
    Bet10Button.addEventListener("mouseover", function (event) {
        Bet10Button.alpha = 0.5;
    });

    Bet10Button.addEventListener("mouseout", function (event) {
    ...
    Bet25Button.addEventListener("mouseover", function (event) {
        Bet25Button.alpha = 0.5;
    });

    Bet25Button.addEventListener("mouseout", function (event) {
    ...
    Bet50Button.addEventListener("mouseover", function (event) {
        Bet50Button.alpha = 0.5;
    });
    Bet50Button.addEventListener("mouseout", function (event) {
...
function SpinButtonClick(event) {
    if (credits == 0) {
